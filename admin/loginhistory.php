...
if(isset($_GET['Submit']) && $_GET['Submit'] == 'Submit')
	...
	//echo $extra;
	echo "<script language='JavaScript'>window.location = 'loginhistory.php?".$extra."';</script>";
	exit();
}
                ...
                <tr>
                    ...
                    <td width="850" align="center" valign="top"><!--TD Start-->
                        <table width="835" border="0" cellspacing="0" cellpadding="0">
                            <tr><td align="left" class="TitleStyle"><b>Reports &gt; History Logs</b></td></tr>
                            ...
                            <tr>
                                <td align="left">
                                    ...
                                    <table width="825" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                        <td>
                                        <form action="loginhistory.php" name="AuditLog" method="get" onsubmit="return validateForm();">
                                        <table width="825" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="99">From</td>
                                          <td width="10"> : </td>
                                        ...
                                        <tr>
                                            <td>Username</td>
                                            <td> : </td>
                                            <td><input type="text" autocomplete="off" id="Username" name="Username" value="<?php echo trim($_GET['Username']); ?>" style="width:186px;" class="txtbox1" /></td>
                                        </tr>                                         
                                        <tr><td height="5"></td></tr>
                                        <!--<tr>
                                            <td>Log Type</td>
                                            ...
                                            <td>
                                            	...
                                            	<select name="LogType" class="dropdown1" onchange="document.getElementById('DivHistoryLog').style.display = (this.value == 'History Log' ? 'block' : 'block' );">
                                            		    <?php
                                                        $sql = "SELECT _LogTypeName FROM ".$tbname."_logtype where _ID = 2";
                                        ...
                                        <?php 
                                              ...
                                              ?>    
                                              <?php //echo $rs['_LogTypeName'];?> 
                                        <input type="hidden" name="LogType" value="<?php echo $rs['_LogTypeName'];?>" />         
                                        <tr>
                                            <td colspan="3">
                                                <div id="DivHistoryLog" style="display:<?=(trim($_GET['LogType']) == "History Log" ? "block;" : "block;")?>">
                                                    <table width="835" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="100">Event</td>
                                                            <td width="9"> : </td>
                                                            <td width="725"><input type="text" autocomplete="off" id="Event" name="Event" value="<?php echo (trim($_GET['LogType']) == "History Log" ? trim($_GET['Event']) : ""); ?>" style="width:186px;" size="30" class="txtbox1" /></td>
                                                        </tr>
                                                        <tr><td height="5"></td></tr>
                                                        <tr>
                                                            <td>Event Item</td>
                                                            <td> : </td>
                                                            <td><input type="text" autocomplete="off" id="EventItem" name="EventItem" value="<?php echo (trim($_GET['LogType']) == "History Log" ? trim($_GET['EventItem']) : ""); ?>" style="width:186px;" size="30" class="txtbox1" /></td>
                                                        </tr>
										...
										/*$fromdate = $_GET['From'];
																	$todate = $_GET['To'];*/
										$urlString = "&amp;Username=".encrypt($Username,$Encrypt)."&amp;LogType=".encrypt($LogType,$Encrypt)."&amp;Event=".encrypt($Event,$Encrypt)."&amp;EventItem=".encrypt($EventItem,$Encrypt)."&From=".encrypt($fromdate,$Encrypt)."&To=".encrypt($todate,$Encrypt)."";
										//$urlString = "&amp;Username=".encrypt($Username,$Encrypt)."&amp;LogType=".encrypt($LogType,$Encrypt)."&amp;Event=".encrypt($Event,$Encrypt)."&amp;EventItem=".encrypt($EventItem,$Encrypt)."&From=".$fromdate."&To=".$todate."";
