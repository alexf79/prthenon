...
<body>
		...
		<?php
			...
			$comment;
			$qry3="select * from ".$tbname."_comment where _CID='".$CatID."' and _PID='".$PCID."' and _UID='".$_SESSION['userid']."' ";
			$result3=mysql_query($qry3);
			while($row3=mysql_fetch_array($result3))
			{
				$comment=$row3["_comment"];
			}
			
		?>
			<h3 class="add-comment">Add your review for:</h3>
			<form name="frmcomment" action="commentaction1.php" method="post" onsubmit="return validatecomment();" style="
    		margin: 0px auto; width: 452px;">
			...
			<table width="450px;" cellpadding="5" align="center">
				<tr align="center">
					<td class="comment-title"><b><font size="+2"><?php echo $row1['_Title'];?></font></b></td>
				</tr>
				...
				<tr align="center">
					<td>
						<input type="submit" name="Submit" value="Save" class="send-button" />&nbsp;
